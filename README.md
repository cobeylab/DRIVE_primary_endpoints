...
1.2. Run `covariate_and_dropout_analysis.R` to perform the analysis of covariate differences between intervention groups and between dropouts the full set of enrolled participants.
